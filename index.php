...
<header class="header">
    ...
    <div class="header__bottom">
        ...
        <ul class="header-catalog__list" data-catalog-list>
          <li>
            ...
            <ul>
              ...
              <li><a href="#">Серия АВМ/А2ВМ</a></li>
              <li><a href="#">Серия Электрон</a></li>
            </ul>
          </li>
      ...
      <div class="nav">
        <span data-toggle="modal" data-target=".price-list" class="nav__item nav__item--contacts">
          Запросить
          прайс-лист
        </span>
    ...
    <div class="welcome parallax-window" data-parallax="scroll" data-image-src="html/img/warehouse.jpg">
        <div class="welcome__item-wrp welcome__item-wrp--about">
            <div class="welcome__logo"></div>
            <h1 class="welcome__text"><span>ELS-Energo (ООО «ЭлСнаб»)</span> входит в число крупнейших торговых организаций электротехнической промышленности России. Высококачественная продукция используется на всех ведущих предприятиях энергоемких отраслей России, а также стран ближнего зарубежья.</h1>
        </div>
        ...
        <div class="container">
            ...
            <div class="catalog-wrp">
                <div class="catalog__item">
                    ...
                    <p class="catalog__desc">Автоматические выключатели <span>ВА55-43 до 1600А, стационарный, с электроприводом</span></p>
    ...
    <div class="contacts">
        ...
        <div class="contacts-wrp">
            ...
            <div class="contacts__content">
                ...
                <a href="mailto:nva073@yandex.ru" class="contacts__text">nva073@yandex.ru</a>
            </div>
        </div>
    </div>

    <div class="modal fade bd-example-modal-sm question-for-specialist" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form action="./mail.php" method="POST" class="welcome__form" name="callback">
                <div class="welcome__header-form">Заполните форму!</div>
                <input type="text" name="name" placeholder="Имя*" required>
                <input type="tel" name="phone" placeholder="Телефон*" required>
                <input type="email" name="email" placeholder="Электронная почта*" required>
                <input type="text" name="question" placeholder="Вопрос">
    ...
    <div class="modal fade bd-example-modal-sm price-list" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form action="./mail.php" method="POST" class="welcome__form" name="donwload_price">
                <div class="welcome__header-form">Скачать прайс-лист!</div>
                <input type="text" name="name" placeholder="Имя*" required>
                <input type="tel" name="phone" placeholder="Телефон*" required>
                <input type="email" name="email" placeholder="Электронная почта*" required>
                <button type="submit" class="welcome__button">Отправить</button>
